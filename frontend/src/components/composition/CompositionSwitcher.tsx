...
import { Music, ChevronDown, Save, Clock, FolderOpen } from "lucide-react";
        ...
        <>
            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DropdownMenuContent align="start" className="w-[300px]">
                    ...
                    {/* Manage Compositions Button */}
                    <DropdownMenuItem onClick={handleManageClick} className="cursor-pointer">
                        <div className="flex items-center gap-2 w-full">
                            <FolderOpen className="h-4 w-4" />
                            <span className="font-medium">Manage Compositions...</span>
                        </div>
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>

            {/* Composition Manager Dialog */}
            <CompositionLoader open={showManager} onOpenChange={setShowManager} />
        </>
    );
}
