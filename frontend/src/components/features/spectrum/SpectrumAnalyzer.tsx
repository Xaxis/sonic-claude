  ...
  return (
    <div className="h-full w-full flex flex-col p-4">
      ...
      <div className="flex items-center justify-between mb-3 flex-shrink-0">
        <div className="flex items-center gap-2 text-xs text-primary font-medium tracking-wider">
        ...
        <div className="flex items-center gap-2 text-xs font-medium">
          {isConnected ? (
            <>
              ...
              <span className="text-green-400 tracking-wide">STREAMING</span>
            </>
          ) : (
            <>
              <div className="w-2 h-2 rounded-full bg-red-400" />
              <span className="text-red-400 tracking-wide">OFFLINE</span>
            </>
          )}
        </div>
      </div>
      ...
      <canvas
        ref={canvasRef}
        className="w-full flex-1 rounded-lg border border-primary/10 bg-black/40 shadow-inner"
