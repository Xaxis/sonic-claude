...
from backend.services.effect_definitions import (
...
@router.get("/effects/definitions", response_model=EffectListResponse)
...
@router.get("/effects/categories", response_model=List[str])
...
@router.get("/effects/categories/{category}", response_model=EffectListResponse)
